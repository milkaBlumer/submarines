...
function click(event) {
    var scoerDiv = document.getElementById("score");
    var subRestDiv = document.getElementById("subRest");

    scoerDiv.innerHTML = scores;
...
function relocalst() {
    if (localStorage.getItem("smax1") == null) {
        console.log("clean the localstorage");
        localStorage.setItem("smax3", 0);
        localStorage.setItem("smax2", 0);
        localStorage.setItem("smax1", 0);
        /* 
        ...
        */
        ...
        localStorage.setItem("sname3", "player");
        localStorage.setItem("sname2", "player");
        localStorage.setItem("sname1", "player");
    }

}

function getCurrentScore() {
    localStorage.setItem("scurrentScore", scores);
    console.log(localStorage.getItem("user"));
    // if the score is minimal
    if (localStorage.getItem("user") == null) {
        localStorage.setItem("user", "player");
        console.log("chenge the name");
    }
    console.log(localStorage.getItem("scurrentScore"));
    console.log(localStorage.getItem("smax1"));

    let a = parseInt(localStorage.getItem("scurrentScore"));
    let b = parseInt(localStorage.getItem("smax1"));
    let c = parseInt(localStorage.getItem("smax2"));
    let d = parseInt(localStorage.getItem("smax3"));
    if (a > b) {
       // console.log("if1");

        localStorage.setItem("smax3", localStorage.getItem("smax2"));
        localStorage.setItem("smax2", localStorage.getItem("smax1"));
        localStorage.setItem("smax1", localStorage.getItem("scurrentScore"));

        localStorage.setItem("sname3", localStorage.getItem("sname2"));
        localStorage.setItem("sname2", localStorage.getItem("sname1"));
        localStorage.setItem("sname1", localStorage.getItem("user"));
    ...
    // if the score is bigger than the 2nd storage value
        ...
        localStorage.setItem("smax3", localStorage.getItem("smax2"));
        localStorage.setItem("smax2", localStorage.getItem("scurrentScore"));

        localStorage.setItem("sname3", localStorage.getItem("sname2"));
        localStorage.setItem("sname2", localStorage.getItem("user"));

    }
    // if yhe score is bigger than the 3rd value
    else if (a > d) {
     
        localStorage.setItem("smax3", localStorage.getItem("scurrentScore"));

        localStorage.setItem("sname3", localStorage.getItem("user"));
    }
...
function gameWin() {
    ...
    document.getElementById("win").innerText = `congreatulations!!!  you won!
    ${document.getElementById("sname1").innerHTML = localStorage.getItem("user")} 
    score: ${document.getElementById("score").innerHTML = scores}

    place 1: ${localStorage.getItem("smax1")} ${localStorage.getItem("sname1")}
    place 2: ${localStorage.getItem("smax2")} ${localStorage.getItem("sname2")}
    place 3: ${localStorage.getItem("smax3")} ${localStorage.getItem("sname3")}`;
...
function createra() {
    ...
    scoreDiv.id = "scor"
    scoreDiv.textContent = "score: " + "400";
